...
<link rel="stylesheet" href="resources/css/hostsettle.css" type="text/css"/>
<style>
.result{
	color:red;
}
			...
			<div class="container1">
				...
				<div class="container1_box" style="margin-top: 30px;">
					...
					<div class="box_2">
						...
						<input type="text" name="space_choice" placeholder="공간을 선택해주세요"
							list="space">
						<datalist id="space">
							<option>따뜻한 한옥 카페</option>
							<option>테라스가 있는 카페</option>
						</datalist>
						<intput type="submit"> <img src="resources/images/host_images/search.png"
							class="searchIcon" style="width: 27px; height: 28px;"></intput>
					</div>
				</div>
			</div>
		</form>
		  <div class="container2" style="height:1000px;"> <!--스크롤 테스트 삭제예정-->
           <div class="container2_title">
               <h5 style="font-size:16px;"><p>2020년1월</p>의 정산내역입니다.</h5>
           </div>
           <div class="payment">
            ...
            <button class="btn btn-primary">엑셀파일 다운받기</button>
        </div>
