...
<script>
    ...
    <div id="spaceInsertContainer">
        <form id="spaceInsertForm"action="spaceModify.ho" method="post">
            <h5><span class="importh">공간정보 수정</span></h5>
                <hr>
                ...
                <div id="form_1"class="spaceForm">
                    <table class="form_1_table">
                        <tr class="title">
                            ...
                            <td colspan="2">
                                <input type="text" class="form-control" name="spcName" placeholder="공간명을 입력해주세요!">
                            </td>
                        </tr>
                        <tr class="introduce">
                        ...
                        <tr class="introduce">
                            ...
                            <td colspan="2">
                                <textarea rows="6"class="form-control" id="introduceSpc" name="spcLong"></textarea>
